 ...
 * @end
 */
Zone.prototype.bindCallback = function(fn, soureZone, options) {
 ...
 * @end
 */
Zone.prototype.bindAsyncCallback = function(fn, soureZone, options) {
  var autoRelease = true;
  var signalCallback = null;
  var releaseCallback = null;
  var name = 'anonymous';
  ...
  var wrapper = function() {
    ...
    return delegate.applyAsync(this, arguments);
  };
  return wrapper;
};
