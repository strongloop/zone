...
function Gate(fn, dependency) {
  ...
  if (dependant === dependency) {
    ...
    dependant._register(id, self);
    dependant._ref(!dependency ? true : dependency, false);
  ...
  self.close = function() {
    ...
    dependant._unregister(id, self);
    dependant._ref(false, !dependency ? true : dependency);
  };
