...
function Zone(body, options, callback) {
  ...
  if (!(this instanceof Zone) || this.hasOwnProperty('id'))
    return new Zone(body, options, callback);
...
function create(body, options, callback) {
  return new Zone(body, options, callback);
}

function define(body, options, callback) {
  return function() {
    var args = arguments;
    ...
    wrappedBody._zoneName = body.name;
...
Zone.prototype.create = create;
Zone.prototype.define = define;
