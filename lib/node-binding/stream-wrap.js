  ...
  function patchPrototype(prototype) {
    ...
    if (prototype.readStart) {
      ...
      prototype.readStart = function() {
        ...
        this.__read_gate__.signal = prototype.readStop.bind(this);
    ...
    if (prototype.listen) {
      ...
      prototype.listen = function(/* backlog */) {
        ...
        // TODO: there is not way to stop listening currently, beholden
        // just closing the server and hoping for the best. Not nice.
        this.__listen_gate__.signal = this.signal.bind(this);
