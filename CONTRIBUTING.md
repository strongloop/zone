...
Thank you for your interest in `zone`, an open source project
administered by StrongLoop.

Contributing to `zone` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/zone)
