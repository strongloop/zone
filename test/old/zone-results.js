...
tap.test('zone can return values', function(t) {
  ...
  zone.create(function returningZone() {
    zone.return('hi');
  }, returns3(t, 'hi'));
});
...
tap.test('zone can return value in timeout', function(t) {
  ...
  zone.create(function timeoutReturningZone() {
    setTimeout(function() {
      zone.return('ok');
    }, 1);
  }, returns3(t, 'ok'));
...
tap.test('zone can return multiple values', function(t) {
  ...
  zone.create(function multipleResultZone() {
    zone.return('hi', 'bert');
  }, returns3(t, 'hi', ['bert']));
});
...
tap.test('zones catch direct errors', function(t) {
  ...
  zone.create(function directCatchingZone() {
    throw Error('bye');
  }, errors2(t, 'bye'));
});
...
tap.test('zones catch indirect errors', function(t) {
  t.plan(2);
  zone.create(function indirectCatchingZone() {
